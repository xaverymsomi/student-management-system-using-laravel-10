                ...
                <div class="card">
                    ...
                    <div class="card-body collapse">
                        ...
                        <div class="text-center mt-3">
                            <a target="_blank" href="{{ route('marks.print', [App\Helpers\Qs::hash($student_id), $ex->id, $year]) }}" class="btn btn-secondary btn-lg">Print Marksheet <i class="icon-printer ml-2"></i></a>
                        </div>

                            ...
                            <table class="table table-bordered">
                                ...
                                @if($user->user_type == 'parent')
                                    <tr>
                                        ...
                                        <td>
                                        @foreach(App\Helpers\Qs::findMyChildren($user->id) as $sr)
                                            <span> - <a href="{{ route('students.show', App\Helpers\Qs::hash($sr->id)) }}">{{ $sr->user->name.' - '.$sr->my_class->name. ' '.$sr->section->name }}</a></span><br>
                                ...
                                @if($user->user_type == 'teacher')
                                    <tr>
                                        ...
                                        <td>
                                            @foreach(App\Helpers\Qs::findTeacherSubjects($user->id) as $sub)

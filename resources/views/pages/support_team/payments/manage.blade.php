                    ...
                    @foreach($students as $s)
                        <tr>
                            ...
                            <div class="dropdown-menu dropdown-menu-left">
                                <a href="{{ route('payments.invoice', [App\Helpers\Qs::hash($s->user_id)]) }}" class="dropdown-item">All Payments</a>
                                @foreach(Pay::getYears($s->user_id) as $py)
                                @if($py)
                                    <a href="{{ route('payments.invoice', [App\Helpers\Qs::hash($s->user_id), $py]) }}" class="dropdown-item">{{ $py }}</a>
                                @endif
                                @endforeach
                            </div>
                                </div>
